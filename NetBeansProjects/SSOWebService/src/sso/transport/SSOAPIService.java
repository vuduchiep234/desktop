...
public class SSOAPIService {
    ...
    private static final Logger _logger = LoggerFactory.getLogger(SSOAPIService.class);
    private static SSOAPIService _instance;
    private static String _host = "";
    private static int _port = 0;

    static {
        _host = Config.getParamString("SSOAPI", "host", "");
        _port = Config.getParamInt("SSOAPI", "port", 3003);

    }

    public static SSOAPIService getInstance() {
        if (_instance == null) {
            _instance = new SSOAPIService();
        }
