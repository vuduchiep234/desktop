	...
	${MENU}
            ...
            <header class="div-prifle">
                <div class="container">
                    <div id="thontin" class="col-xs-12">
                        <div id="username_left" class="col-xs-3">
                            <span id="username">Thay mật khẩu</span>
                        </div>
                    ...
                    <div id="thongtinchitiet" class="col-xs-12">
                        ...
                        <div class="col-xs-9">
                                <div class="text" >
                                    ...
                                    <br>
                                        <input id="oldPassword" class="input-style" type="password"  place="Họ và tên"></input>
                                </div>
                                <div class="text" >
                ...
                <div id="capnhat" class="container text-right">
                    <div class="col-xs-12">
                        <a class ="btn-prfile" id="btnChangePassword" href="#">Cập nhật</a>
                    </div>
                </div>        
        </div>
    </header>
