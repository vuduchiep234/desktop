...
public class ConfigVNPAY {
    ...
    public static String vnp_Returnurl_MCDT = "http://localhost:8080/vnpay_jsp/vnpay_return.jsp";
    public static String vnp_TmnCode = "ADPKENH1";
    public static String vnp_HashSecret = "GETFGDBMDXBHYCVTXWFQRCFKXCVKMRLO";
