 ...
 * @author anbq
 */
public class CongThanhToanWeb {

    private static final Logger _logger = LoggerFactory.getLogger(CongThanhToanWeb.class);
    private static CongThanhToanWeb _instance;
    private static String _host = "";
    private static int _port = 0;

    static {
        _host = Config.getParamString("CongThanhToanAPI", "host", "");
        _port = Config.getParamInt("CongThanhToanAPI", "port", 2004);

    }

    public static CongThanhToanWeb getInstance() {
        if (_instance == null) {
            _instance = new CongThanhToanWeb();
        }
    ...
    public JSONObject getApi(String path) {
        ...
        try {
            ...
            if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                respon.put("responseMessage", "Call API successfully!");
            } else {
                respon.put("responseCode", conn.getResponseCode());
