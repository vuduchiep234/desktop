        ...
        <div class="main-content">
            <div class="container">
                <div class="document-parent text-center" style="border: 0px solid !important;padding:120px">
                    <img src="${static_url}assets/img/icon-failed.png">
						<h5 class="payment-label font-weight-bolder mt-5">Thanh Toán</h5>
						<h4 class="payment-status-failed font-weight-bold">KHÔNG THÀNH CÔNG</h4>
						<button id="btnBack" type="button" class="btn btn-try-again">OK</button>
                </div>
