...
public class ServletUtil {
    ...
    public static int getIntParameter(Request request, String paramName, int defaultValue) {
        String paramString = getStringParameter(request, paramName, false);
        if (paramString == null) {
            return defaultValue;
        }
        int paramValue;
    ...
    public static String getStringParameter(Request request, String paramName, boolean encoded) {
        return getStringParameter(request, paramName, "", encoded);
    }

    public static String getStringParameter(Request request, String paramName, String defaultValue, boolean encoded) {
        String paramString = getParameter(request, paramName.toLowerCase());
        if (paramString == null) {
            return defaultValue;
        }
        if (paramString.contains(" ") && encoded) {
            try {
                paramString = URLEncoder.encode(paramString, StandardCharsets.UTF_8.name());
